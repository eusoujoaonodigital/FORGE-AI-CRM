...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Sala privativa o dia todo",
      "Impressora e scanner",
      "Armário individual",
      "Sala de reunião 1h grátis",
    ],
    highlight: true,
  },
  {
    ...
    features: [
      "Tudo do plano Diária",
      "Mesa fixa dedicada",
      "Endereço fiscal completo",
      "Sala de reunião 8h/mês",
      "Desconto em eventos",
      "Suporte prioritário",
    ],
    highlight: false,
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-2xl p-6 md:p-8 flex flex-col ${
                  plan.highlight
                    ? "glass-card-gold shadow-gold-lg scale-[1.02] md:scale-105"
                    : "glass-card"
                }`}
              >
                {plan.highlight && (
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Presencial: {plan.priceWalkIn}{plan.unit}
                </p>
